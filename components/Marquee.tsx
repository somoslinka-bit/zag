...
const logos = [
  ...
  { src: '/logos/atalaya.png',           alt: 'Atalaya' },
  { src: '/logos/auki.png',              alt: 'Auki' },
  { src: '/logos/basilico.png',          alt: 'Basílico' },
  { src: '/logos/datastar.png',          alt: 'Datastar' },
  ...
  { src: '/logos/premin.png',           alt: 'Premin' },
  ...
  { src: '/logos/casa-blanco.jpg',           alt: 'Casa Blanco' },
      ...
      <div className="relative flex overflow-x-hidden">
        <div className="py-4 animate-marquee flex items-center gap-12 px-8 whitespace-nowrap">
          {track.map((logo, index) => (
            <div key={index} className="flex-shrink-0 flex items-center justify-center" style={{ width: '160px', height: '64px' }}>
              <img
                src={logo.src}
                alt={logo.alt}
